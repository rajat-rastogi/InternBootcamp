...
public interface class IAllJoynCarConsumer
{
    event Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
    event Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Platform::Object^>^ StateChanged;
};

public ref class AllJoynCarConsumer sealed  : [Windows::Foundation::Metadata::Default] IAllJoynCarConsumer
{
public:
    AllJoynCarConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~AllJoynCarConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<AllJoynCarJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ AllJoynCarWatcher^ watcher);

    // Call the Drive method
    Windows::Foundation::IAsyncOperation<AllJoynCarDriveResult^>^ DriveAsync(_In_ bool interfaceMemberOnOff, _In_ uint32 interfaceMemberDirection);

    // Get the value of the Speed property.
    Windows::Foundation::IAsyncOperation<AllJoynCarGetSpeedResult^>^ GetSpeedAsync();

    // Set the value of the Speed property.
    Windows::Foundation::IAsyncOperation<AllJoynCarSetSpeedResult^>^ SetSpeedAsync(_In_ uint32 value);
    // This event fires whenever the value of State changes.
    virtual event Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Platform::Object^>^ StateChanged 
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Platform::Object^>^ handler) 
        { 
            return _StateChanged += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<AllJoynCarConsumer^>(sender), safe_cast<Platform::Object^>(args));
    ...
    internal: 
        void raise(AllJoynCarConsumer^ sender, Platform::Object^ args) 
        { 
    ...
    Windows::Foundation::IAsyncOperation<AllJoynCarGetStateResult^>^ GetStateAsync();
    ...
    virtual event Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost 
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ handler) 
        { 
            return _SessionLost += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<AllJoynCarConsumer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(AllJoynCarConsumer^ sender, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^ args) 
        { 
    ...
    virtual event Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded 
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ handler) 
        { 
            return _SessionMemberAdded += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<AllJoynCarConsumer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(AllJoynCarConsumer^ sender, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^ args) 
        { 
    ...
    virtual event Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved 
    { 
        Windows::Foundation::EventRegistrationToken add(Windows::Foundation::TypedEventHandler<AllJoynCarConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ handler) 
        { 
            return _SessionMemberRemoved += ref new Windows::Foundation::EventHandler<Platform::Object^>
            ([handler](Platform::Object^ sender, Platform::Object^ args)
            {
                handler->Invoke(safe_cast<AllJoynCarConsumer^>(sender), safe_cast<Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>(args));
            }, Platform::CallbackContext::Same);
        } 
        void remove(Windows::Foundation::EventRegistrationToken token) 
        { 
    ...
    internal: 
        void raise(AllJoynCarConsumer^ sender, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^ args) 
        { 
